...
const STYLES = [
  ...
  { id: "plush", label: "Plush", icon: "🧸", previewUrl: "https://cdn.useaudora.com/assets/audora-plushy-style.png" },
...
export default function StudioDetailPage() {
  ...
  useEffect(() => {
    if (generation && !hasInitialized.current) {
      ...
      const matchedPos = POSITIONS.find(p => p.id.toLowerCase().replace(/ /g, "_") === formattedPos)?.id || "Isometric";
