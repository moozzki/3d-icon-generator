...
export const STYLE_REFINE_PROMPTS: Record<StyleKey, string> = {
  plastic:
    "Transform the reference image based on this request: '{subject}'. Render the final result as a highly detailed 3D character/icon in a premium matte vinyl designer toy style, {position}, clean composition. Feature soft, diffused ambient lighting with minimal shadows and no harsh specular highlights. Strictly isolated on a flawless pure solid white background (#FFFFFF). Zero background noise, no artifacts. {quality}.",

  clay:
    "Transform the reference image based on this request: '{subject}'. Render the final result as a stylized 3D icon made of soft clay material with slightly imperfect edges and handcrafted texture details. {position}, balanced composition. Rendered with soft lighting to enhance tactile depth. Strictly isolated on a flawless pure solid white background (#FFFFFF). Zero background noise, no artifacts. {quality}.",

  glass:
    "Transform the reference image based on this request: '{subject}'. Render the final result as a premium 3D icon made of translucent glass material, featuring realistic refraction, reflections, and light dispersion. {position}, elegant composition. Rendered with studio lighting. Strictly isolated on a flawless pure solid white background (#FFFFFF) with a subtle shadow. Zero background noise, no artifacts. {quality}.",

  plush:
    "Transform the reference image based on this request: '{subject}'. Render the final result as a cute 3D icon in a plush fabric style, featuring soft fibers, fuzzy texture, and rounded shapes. {position}, friendly and playful composition. Rendered with soft lighting and subtle shadow. Strictly isolated on a flawless pure solid white background (#FFFFFF). Zero background noise, no artifacts. {quality}.",

  toy_block:
    "Transform the reference image based on this request: '{subject}'. Render the final result as a playful 3D icon in a toy building block style, featuring bold shapes, vibrant colors, and smooth interlocking surfaces. {position}, structured composition. Rendered with soft lighting. Strictly isolated on a flawless pure solid white background (#FFFFFF). Zero background noise, no artifacts. {quality}.",

  metallic:
    "Transform the reference image based on this request: '{subject}'. Render the final result as a high-end 3D icon in a metallic chrome material style, featuring polished surfaces, sharp reflections, realistic highlights, and subtle shadow. {position}, strong composition. Rendered with studio lighting. Strictly isolated on a flawless pure solid white background (#FFFFFF). Zero background noise, no artifacts. {quality}.",
};
